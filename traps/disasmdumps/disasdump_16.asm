  ...
  cd:   ds (bad) 
  cf:   rcr    bl, cl
  d1:   xor    ch, BYTE PTR [rax]
  d3:   or     edi, ecx
  d5:   lahf   
  d6:   ins    DWORD PTR es:[rdi], dx
  d7:   cmp    DWORD PTR [rsi+0x4e], ebp
  da:   jle    0xe6
  dc:   and    DWORD PTR [edx-0x5118272], ecx
  e3:   xor    BYTE PTR [rbx+0xf192545], al
  e9:   jg     0x13f
  eb:   mov    es, eax
  ed:   (bad)  
  ee:   xor    DWORD PTR [rax+0x61c0822e], ebp
  f4:   movs   BYTE PTR es:[rdi], BYTE PTR ds:[rsi]
  f5:   pop    rsi
  f6:   fld    QWORD PTR [rax]
  f8:   (bad)
  fc:   loope  0xf3
  fe:   popf   
  ff:   loope  0xd9
