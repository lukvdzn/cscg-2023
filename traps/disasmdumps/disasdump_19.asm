  ...
  bc:   push   rax
  bd:   jmp    0x186
  c2:   and    BYTE PTR [rcx+0x632e8363], al
  c8:   xlat   BYTE PTR ds:[rbx]
  c9:   mov    DWORD PTR [rdx+rdx*1-0x67], 0xe95e40f4
  d1:   (bad)
  d4:   adc    DWORD PTR [rbx], eax
  d6:   sbb    al, 0x83
  d8:   sar    DWORD PTR [rsp+rdx*8-0x2c], cl
  dc:   mov    edx, 0xfb44cf3a
  e1:   rex.WRX and r11, QWORD PTR [rsi+0x2375acbd]
  e8:   movabs al, ds:0x84671e366dcc157b
  f1:   enter  0x90cb, 0xf9
  f5:   fs (bad) 
  f7:   fiadd  WORD PTR [rdx-0x3b]
  fa:   (bad)  
  fb:   in     al, dx
  fc:   femms  
  fe:   retf   
  ff:   mov    edi, 0xb107f27d
 104:   movsxd ebx, DWORD PTR [rbp-0x10f6c870]
 10a:   fwait
 10b:   xchg   edi, eax
 10c:   rex.WB test BYTE PTR [r10], 0x48
 110:   xor    ecx, ecx
 112:   mov    rsi, r13
