  ...
  c4:   int    0x9
  c6:   js     0x105
  c8:   shr    BYTE PTR [rbx+0x75aca063], 1
  ce:   or     edi, ecx
  d0:   ins    DWORD PTR es:[rdi], dx
  d1:   xlat   BYTE PTR ds:[rbx]
  d2:   xor    al, 0x6b
  d4:   cli    
  d5:   rex.RXB int 0x12
  d8:   or     DWORD PTR [rcx-0x66a67536], edi
  de:   xchg   esp, eax
  df:   mov    gs, edi
  e1:   (bad)  
  e2:   loop   0xa7
  ...
  ea:   jp     0x73
  ec:   loope  0x91
  ee:   cmps   BYTE PTR ds:[rsi], BYTE PTR es:[rdi]
  ef:   fdiv   DWORD PTR [rdx-0x3cafe3ec]
  f5:   cld    
  f6:   sbb    esi, 0xd1f76287
  fc:   mov    cs, WORD PTR [rcx-0x6c]
  ff:   adc    DWORD PTR [rbx-0x6ee674d5], eax
 105:   rex.WXB xchg r8, rax
 107:   xor    al, 0x9
 109:   out    dx, eax
 10a:   fwait
 10b:   xchg   edi, eax
