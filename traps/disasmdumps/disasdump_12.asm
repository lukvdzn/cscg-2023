  ...
  bc:   push   rax
  bd:   jmp    0x186
  c2:   mov    esp, 0xa675cde7
  c7:   pop    rbx
  c8:   (bad)  
  c9:   sbb    al, 0xe8
  cb:   gs jrcxz 0xb5
  ce:   pop    rdi
  cf:   movabs eax, ds:0xbd1f801f05e7cf5
  d8:   ins    DWORD PTR es:[rdi], dx
  d9:   sbb    al, 0x3c
  db:   add    BYTE PTR [rbp-0x3fea0825], ah
  e1:   cmc    
  e2:   repz cmps DWORD PTR ds:[rsi], DWORD PTR es:[rdi]
  e4:   in     al, dx
  e5:   mov    dh, 0xdb
  e7:   (bad)  
  e9:   mov    esp, DWORD PTR [rsi+0x7e]
  ec:   mov    dh, 0x90
  ee:   cmp    bh, cl
  f0:   xor    BYTE PTR [rbp-0x2eebeba1], al
  f6:   rex.RXB xchg DWORD PTR [r9], r12d
  f9:   pop    rbx
  fa:   jg     0x123
  fc:   mov    ds, WORD PTR [rdi+riz*2]
  ff:   adc    eax, 0xc0842991
 104:   push   0xa799089
 109:   (bad)  
 10a:   fcmove st, st(6)
