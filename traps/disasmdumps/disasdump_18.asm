  ...
  bd:   jmp    0x186
  c2:   xor    al, 0x7d
  c4:   sbb    eax, 0x677ea6ee
  c9:   xlat   BYTE PTR ds:[rbx]
  ca:   out    0x3a, al
  cc:   test   al, 0xc0
  ce:   xor    esp, esp
  d0:   mov    esi, 0x99736353
  d5:   mul    BYTE PTR [rdi]
  d7:   lahf   
  d8:   ds nop
  da:   int1   
  db:   stc    
  dc:   and    DWORD PTR [rbx-0x39], eax
  df:   push   0xfffffffffebc0bc8
  e4:   jmp    0x751d653c
  e9:   sub    eax, 0x86ff4195
  ee:   fild   DWORD PTR [rdi+0x54]
  f1:   lea    esp, [rcx-0x5f6a56e5]
  f7:   cld    
  f8:   rex.WRB cmps QWORD PTR ds:[rsi], QWORD PTR es:[rdi]
  fa:   ds mov ch, 0x3e
  fd:   add    DWORD PTR [rsi+0x59], 0xfffffff6
 101:   push   rbp
 102:   shl    BYTE PTR [rbx], cl
 104:   (bad)  
 105:   (bad)  
 106:   nop
 107:   es or  edi, ebp
