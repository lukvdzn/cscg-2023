  ...
  c3:   (bad)  
  c4:   in     al, dx
  c5:   rex.WRB adc QWORD PTR [r10], 0xffffffffffffffcb
  c9:   nop
  ca:   xchg   ebx, eax
  cb:   (bad)  
  cc:   cmp    bh, BYTE PTR [rax+0x498d1ad1]
  d2:   rex.WX
  d3:   cs jle 0xed
  d6:   test   BYTE PTR [rcx-0x3f6da10c], ah
  dc:   pushf  
  dd:   mov    DWORD PTR gs:[rbp+riz*1-0x688f585f], edx
  e5:   mov    dl, 0x7a
  e7:   sbb    DWORD PTR [rdx-0x1ebfed74], esp
  ed:   ret    0x9cc3
  f0:   rex.XB pop r15
  f2:   push   rsp
  f3:   clc    
  f4:   mov    ds, WORD PTR [rbx+0x16]
  f7:   (bad)  
  f8:   mov    ah, 0x47
  fa:   push   rsi
  fb:   xchg   edi, eax
  fc:   (bad)  
  fd:   xchg   ecx, eax
  fe:   or     ah, BYTE PTR [rcx-0x6d]
 101:   lea    edx, [rip+0xffffffff908e504d]        # 0xffffffff908e5154
 107:   (bad)  
 109:   cmp    al, 0x2
 10b:   or     al, 0xc0
