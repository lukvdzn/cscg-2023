  ...
  c6:   rex pop rdx
  c8:   sbb    al, 0xac
  ca:   not    DWORD PTR [rbp+0x1e4a7b24]
  d0:   out    0x40, eax
  d2:   mov    BYTE PTR [rcx+0x58b8538c], dl
  d8:   adc    ebx, eax
  da:   jbe    0xaf
  dc:   xchg   edx, eax
  dd:   (bad)  
  de:   cmps   DWORD PTR ds:[rsi], DWORD PTR es:[rdi]
  df:   repz push rbp
  e1:   shr    edi, 0xc8
  e4:   (bad)  
  e5:   pop    rbx
  e6:   (bad)  
  e7:   (bad)  
  e8:   push   0xffffffffac9ecc7b
  ed:   clc    
  ee:   rex ins BYTE PTR es:[rdi], dx
  f0:   (bad)  
  f1:   out    dx, al
  f2:   rcr    DWORD PTR [rdi+0x27], 1
  f5:   repnz es mov esp, 0xd62e6a46
  fc:   je     0xc8
  fe:   adc    DWORD PTR [rdx+0x42], esp
 101:   popf   
 102:   ja     0x113
 104:   gs jnp 0x97
 107:   add    ebp, eax
