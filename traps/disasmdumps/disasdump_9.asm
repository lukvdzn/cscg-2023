  ...
  bc:   push   rax
  bd:   jmp    0x186
  c2:   enter  0x6cc5, 0xef
  c6:   sar    BYTE PTR [rip+0xffffffffac3b2d15], cl        # 0xffffffffac3b2de1
  cc:   fimul  WORD PTR [rbx]
  ce:   jrcxz  0xfd
  d0:   fld    TBYTE PTR [rip+0x74ce3d45]        # 0x74ce3e1b
  d6:   (bad)  
  d7:   sti    
  d8:   test   eax, 0xbb748310
  dd:   add    DWORD PTR [rbp+0x33], eax
  e0:   adc    cl, cl
  e2:   pop    rsi
  e3:   xchg   ecx, eax
  e4:   cli    
  e5:   add    esi, DWORD PTR [rbx]
  e7:   xchg   rdi, rax
  e9:   loop   0xa5
  eb:   sbb    DWORD PTR [rcx+0x3d13f903], ecx
  f1:   jno    0xc1
  f3:   (bad)  
  f4:   (bad)  
  f5:   js     0x14f
