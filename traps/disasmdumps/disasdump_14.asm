  ...
  c4:   mov    bh, 0x5a
  c6:   mov    bl, 0x61
  c8:   scas   al, BYTE PTR es:[rdi]
  c9:   push   rdx
  ca:   mov    dh, BYTE PTR [rdi+0x57ad1fe1]
  d0:   mov    ch, 0x82
  d2:   lods   al, BYTE PTR ds:[rsi]
  d3:   fmulp  st(2), st
  d5:   sub    eax, 0xa25c6a68
  da:   sahf   
  db:   rex.WRXB fnstcw WORD PTR [r8]
  de:   (bad)  [rsi+0x6d8c4abc]
  e4:   adc    ch, BYTE PTR [rbp-0x2f06ecbf]
  ea:   (bad)  
  eb:   sbb    al, 0xbf
  ed:   or     eax, 0x652a7cb6
  f2:   stos   DWORD PTR es:[rdi], eax
  f3:   (bad)  
  f4:   loop   0x14c
  f6:   or     BYTE PTR [rcx], bl
  f8:   xor    al, 0xed
  fa:   xor    al, BYTE PTR [rdx+0x55]
  fd:   loopne 0x16a
  ff:   (bad)  
 100:   or     DWORD PTR [rsi-0x7d67fe5a], ebp
 106:   nop
 107:   (bad)  
 108:   rex.X mov DWORD PTR [rax+0x2f6490d], edx
 10f:   xor    rcx, rcx
 112:   mov    rsi, r13
