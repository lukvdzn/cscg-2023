  ...
  bd:   jmp    0x186
  c2:   jns    0x77
  c4:   scas   al, BYTE PTR es:[rdi]
  c5:   add    r12b, BYTE PTR [rip+0x674175dd]        # 0x674176a9
  cc:   je     0x132
  ce:   rex.RX ja 0xdc
  d1:   test   DWORD PTR [rbp+0xd], esi
  d4:   call   0xfffffffff2433e5c
  d9:   pushf  
  da:   add    al, 0xfa
  dc:   in     eax, 0x97
  de:   add    bl, dl
  e0:   je     0x65
  e2:   fadd   QWORD PTR [rax]
  e4:   mov    eax, 0x839145af
  e9:   stos   BYTE PTR es:[rdi], al
  ea:   (bad)  
  eb:   lock loope 0x149
  ee:   (bad)  
  ef:   int1   
  f0:   or     ah, BYTE PTR [rsi]
  f2:   sbb    DWORD PTR [rbx], 0xffffffb6
  f5:   mov    esp, 0x535451c0
  fa:   push   rsi
  fb:   adc    eax, 0x1e8eb27f
 100:   fnsave [rcx]
 102:   rcr    DWORD PTR [rdi+rdi*2], 0x37
 106:   nop
 107:   in     eax, dx
 108:   pop    rcx
 109:   out    dx, eax
